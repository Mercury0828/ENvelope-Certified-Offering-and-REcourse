...
only institutional element in the model. It does not claim to replicate any
specific ERCOT service: qualification, telemetry, and performance rules of
ECRS are not modeled; ECRS clearing prices serve as the capacity-price
stream, and $p_{\mathrm{act}}$ and $\gamma$ are product design parameters
