...
## Defensiveness + AI-trace sweep (owner, 2026-06-11): full checklist rerun on v9; 32 proposals, all applied (4 DEFENSIVE leads removed incl. 'does not claim to replicate'; 6 prose em-dash pairs; 'exactly/precisely' tic 7x trimmed; 'by construction/is what/heartbeat/genuine/critically' tics; duplicate B7 apposition; redundant roadmap sentence; 2x 'survives'; baseline/pairing remarks restated as plain facts). Token sweep otherwise clean; legitimate math disambiguations kept. Builds clean, 12 pp.
